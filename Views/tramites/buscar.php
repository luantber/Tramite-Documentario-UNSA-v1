...
<form class="form-horizontal container">
	<div class="form-group" >
		...
		<div class="col-sm-10" >
			<label class="radio-inline"><input type="radio" name="bus" id="buscar" value="apellido" >Apellidos</label>			
			<label class="radio-inline"><input type="radio" name="bus" id="buscar" value="dni" >DNI</label>
		</div>		
	</div>
